...
export default class Webcam extends React.Component<WebcamProps, WebcamState> {
  ...
  private requestUserMedia() {
    ...
    const sourceSelected = (audioConstraints: MediaStreamConstraints["audio"] | undefined, videoConstraints: MediaStreamConstraints["video"] | undefined) => {
    ...
    if ("mediaDevices" in navigator) {
      ...
      const optionalSource: any = (id: any) => ({ optional: [{ sourceId: id }] });
